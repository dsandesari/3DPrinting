...
#define vtksys_DATE_STAMP_STRING_DAY   "13"

/** Version date full string.  The format is "CCYYMMDD".  */
#define vtksys_DATE_STAMP_STRING_FULL  "20090313"

/** Version date formatted string.  The format is "CCYY-MM-DD".  */
#define vtksys_DATE_STAMP_STRING       "2009-03-13"
