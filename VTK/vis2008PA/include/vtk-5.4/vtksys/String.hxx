 ...
 */
class vtksys_EXPORT String: public vtksys_stl::string
{
  /** The original string type.  */
  typedef vtksys_stl::string stl_string;
...
inline bool operator<(String const& l, String const& r)
  {
  return (static_cast<vtksys_stl::string const&>(l) <
          static_cast<vtksys_stl::string const&>(r));
  }
#endif
