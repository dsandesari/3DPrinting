...
struct hash_select1st:
    public vtksys_stl::unary_function<vtksys_stl::pair<T1, T2>, T1>
{
  const T1& operator()(const vtksys_stl::pair<T1, T2>& __x) const
    { return __x.first; }
};
...
template <class _Key, class _Tp,
          ...
          class _EqualKey = vtksys_stl::equal_to<_Key>,
...
{
private:
  typedef hashtable<vtksys_stl::pair<const _Key,_Tp>,_Key,_HashFcn,
...
public:
  ...
  friend bool operator==vtksys_CXX_NULL_TEMPLATE_ARGS(const hash_map&,
                                                                 const hash_map&);
...
public:
  ...
  vtksys_stl::pair<iterator, iterator> equal_range(const key_type& __key)
...
public:
  ...
  friend bool operator==vtksys_CXX_NULL_TEMPLATE_ARGS(const hash_multimap&,
                                                                 const hash_multimap&);
